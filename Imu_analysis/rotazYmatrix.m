function [rotmatrix,matrposiniz]=rotazYmatrix(dati,TRmatrix,graf)


TRmatr=[TRmatrix.Points(:,1) TRmatrix.Points(:,2) TRmatrix.Points(:,3)];

%matrice di rotaz rispetto al dato iniziale
R_iniz=roty(-dati(1,2));
